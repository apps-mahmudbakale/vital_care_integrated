...
<div class="row">
    <div class="col-md-12">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form id="editRoleForm" class="row g-3" action="{{ route('app.roles.update', $role->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    
                    <div class="col-12 mb-4">
                        <label class="form-label" for="modalRoleName">Role Name</label>
                        <input type="text" id="modalRoleName" name="name" value="{{ $role->name }}" class="form-control" placeholder="Enter a role name" tabindex="-1" required />
                    </div>
