<div>
    <form wire:submit.prevent="save">
        <div id="radiology-request-repeater">
            ...
            <div class="card mb-3 border border-label-primary">
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <!-- Radiology Test Select2 -->
                        <div class="col-md-6" wire:ignore>
                            <label class="form-label">Select Radiology Test <span class="text-danger">*</span></label>
                            <select class="form-select select2" 
                                ...
                                <option value="{{ $test->id }}" {{ $row['radiology_test_id'] == $test->id ? 'selected' : '' }}>
                    ...
                    @error("rows.$index.radiology_test_id") <div class="text-danger small mt-1">{{ $message }}</div> @enderror
                </div>
            </div>
            @endforeach
        </div>
            ...
            $('.select2').each(function() {
                if (!$(this).hasClass("select2-hidden-accessible")) {
                    $(this).select2({
                        ...
                        let value = $(this).val();
                        @this.set(`rows.${index}.radiology_test_id`, value);
                    });
                }
            });
        }
