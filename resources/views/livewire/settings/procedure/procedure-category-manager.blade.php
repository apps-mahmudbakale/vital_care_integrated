<div>
    <div class="card h-100">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="card-title mb-0">Procedure Categories</h5>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="d-flex justify-content-end gap-1">
                                        ...
                                        <button wire:click="confirmDelete({{ $category->id }})" class="btn btn-sm btn-icon btn-label-danger" data-bs-toggle="modal" data-bs-target="#deleteProcedureCategoryModal">
    ...
    <!-- Add/Edit Modal -->
    <div wire:ignore.self class="modal fade" id="procedureCategoryModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ $editingId ? 'Edit' : 'Add' }} Procedure Category</h5>
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                   wire:model="name" placeholder="e.g. Surgery">
    ...
    <!-- Delete Modal -->
    <div wire:ignore.self class="modal fade" id="deleteProcedureCategoryModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Are you sure? This will delete all procedures in this category.</p>
                </div>
                <div class="modal-footer">
    ...
    <script>
        document.addEventListener('livewire:init', () => {
            const procedureCategoryModal = new bootstrap.Modal(document.getElementById('procedureCategoryModal'));
            Livewire.on('show-category-modal', () => procedureCategoryModal.show());
            Livewire.on('hide-category-modal', () => procedureCategoryModal.hide());
        });
    </script>
</div>
