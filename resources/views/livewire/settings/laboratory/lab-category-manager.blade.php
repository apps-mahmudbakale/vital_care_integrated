<div>
    <div class="card h-100">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="card-title mb-0">Laboratory Categories</h5>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="d-flex justify-content-end gap-1">
                                        ...
                                        <button wire:click="confirmDelete({{ $category->id }})" class="btn btn-sm btn-icon btn-label-danger" data-bs-toggle="modal" data-bs-target="#deleteLabCategoryModal">
    ...
    <!-- Add/Edit Modal -->
    <div wire:ignore.self class="modal fade" id="labCategoryModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ $editingId ? 'Edit' : 'Add' }} Lab Category</h5>
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                   wire:model="name" placeholder="e.g. Hematology">
    ...
    <!-- Delete Modal -->
    <div wire:ignore.self class="modal fade" id="deleteLabCategoryModal" tabindex="-1" aria-hidden="true">
    ...
    <script>
        document.addEventListener('livewire:init', () => {
            const labCategoryModal = new bootstrap.Modal(document.getElementById('labCategoryModal'));
            Livewire.on('show-category-modal', () => labCategoryModal.show());
            Livewire.on('hide-category-modal', () => labCategoryModal.hide());
        });
    </script>
</div>
