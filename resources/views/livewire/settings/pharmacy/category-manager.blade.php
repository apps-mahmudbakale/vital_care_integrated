<div>
    <div class="card h-100">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="card-title mb-0">Drug Categories</h5>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="d-flex justify-content-end gap-1">
                                        ...
                                        <button wire:click="confirmDelete({{ $category->id }})" class="btn btn-sm btn-icon btn-label-danger" data-bs-toggle="modal" data-bs-target="#deleteCategoryModal">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ $editingId ? 'Edit' : 'Add' }} Drug Category</h5>
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                   wire:model="name" placeholder="e.g. Antibiotics">
    ...
    <div wire:ignore.self class="modal fade" id="deleteCategoryModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Are you sure? This will delete all drugs in this category.</p>
                </div>
                <div class="modal-footer">
    ...
    <script>
        document.addEventListener('livewire:init', () => {
            ...
            Livewire.on('show-category-modal', () => categoryModal.show());
            Livewire.on('hide-category-modal', () => categoryModal.hide());
        });
    </script>
</div>
