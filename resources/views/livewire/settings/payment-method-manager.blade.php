<div>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="javascript:void(0)" wire:click="create">
                            <i class="ti tabler-plus me-1"></i> Add Method
                        </a></li>
                ...
                <table class="table table-hover border-top text-nowrap">
                    ...
                    <tbody>
                        @forelse($paymentMethods as $pm)
                            <tr>
                                <td class="fw-medium text-heading">{{ $pm->name }}</td>
                                <td class="text-end">
                                    <div class="d-flex justify-content-end gap-1">
                                        <button wire:click="edit({{ $pm->id }})" class="btn btn-sm btn-icon btn-label-primary">
                                            <i class="ti tabler-edit"></i>
                                        </button>
                                        <button wire:click="confirmDelete({{ $pm->id }})" class="btn btn-sm btn-icon btn-label-danger" data-bs-toggle="modal" data-bs-target="#deletePaymentModal">
                        ...
                        @empty
                            <tr>
                                <td colspan="2" class="text-center text-muted py-4">No payment methods found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ $editingId ? 'Edit' : 'Add' }} Payment Method</h5>
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                   wire:model="name" placeholder="e.g. Cash, Credit Card, Bank Transfer">
    ...
    <div wire:ignore.self class="modal fade" id="deletePaymentModal" tabindex="-1" aria-hidden="true">
